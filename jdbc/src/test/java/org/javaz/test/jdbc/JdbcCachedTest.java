...
//        address = "jdbc:hsqldb:mem:test1;username=SA";
    ...
    {
        test.runUpdateDataIgnore("drop table blobtest", null);
        ...
        test2.runUpdateDataIgnore("drop table blobtest2", null);
    ...
    {
        test.runUpdateDataIgnore("drop table test2", null);
    ...
    {
        test.runUpdateDataIgnore("drop table test3", null);
    ...
    {
        test.runUpdateDataIgnore("drop table test4", null);
    ...
    public void testReplicator() throws Exception
    {
        ...
        test2.runUpdateDataIgnore("drop table test6", null);
        ...
        test.runUpdateDataIgnore("drop table test8", null);
        test2.runUpdateDataIgnore("drop table test8", null);
