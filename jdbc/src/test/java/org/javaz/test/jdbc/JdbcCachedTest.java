...
//        address = "jdbc:hsqldb:mem:test1;username=SA";
    ...
    {
        test.runUpdateNoError("drop table test", null);
    ...
    {
        test.runUpdateNoError("drop table blobtest", null);
        ...
        test2.runUpdateNoError("drop table blobtest2", null);
    ...
    {
        test.runUpdateNoError("drop table test2", null);
    ...
    {
        test.runUpdateNoError("drop table test3", null);
    ...
    {
        test.runUpdateNoError("drop table test4", null);
    ...
    {
        test.runUpdateNoError("drop table test5", null);
        test2.runUpdateNoError("drop table test6", null);
        ...
        test.runUpdateNoError("drop table test8", null);
        test2.runUpdateNoError("drop table test8", null);
